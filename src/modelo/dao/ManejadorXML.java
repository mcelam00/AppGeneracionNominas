...
public class ManejadorXML {
	...
	public void escribirErroresXML(ArrayList<Trabajadorbbdd> trabajadoresNifErroneo) {
		 ...
		 try {
		        ...
		        Element trabajadores = new Element("Trabajadores"); //creamos el nodo ra�z trabajadores
		        Document documento = new Document(trabajadores);
		        
		        for (Trabajadorbbdd t : trabajadoresNifErroneo) { //recorremos los trabajadores erroneos a a�adir
	...
	public void escribirErroresCCCXML(ArrayList<Trabajadorbbdd> trabajadoresCCCErroneas) {
		 ...
		 try {
		        ...
		        Element cuentas = new Element("Cuentas"); //creamos el nodo ra�z 
		        Document documento = new Document(cuentas);
		        
		        for (Trabajadorbbdd t : trabajadoresCCCErroneas) { //recorremos los trabajadores erroneos a a�adir
